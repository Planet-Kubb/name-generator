<html>
<head>
	<title>Planet Kubb Team Name Generator (no)</title>
...
<div class="container">
	<div class="row-fluid">
		<div class="alert alert-info">
			<strong>Want to create the Norsk team name generator?</strong> <a href="https://github.com/thingles/Planet-Kubb-Name-Generator">Fork the code on Github</a> and issue a pull request when you have it ready!
		</div>
	</div>
