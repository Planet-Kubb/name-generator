<html>
<head>
	<title>Planet Kubb Team Name Generator (es)</title>
...
<div class="container">
	<div class="row-fluid">
		<div class="alert alert-info">
			<strong>Want to create the Espa&ntilde;ol team name generator?</strong> <a href="https://github.com/thingles/Planet-Kubb-Name-Generator">Fork the code on Github</a> and issue a pull request when you have it ready!
		</div>
	</div>
...
<?
	...
	*/
	...
	$name = "&iquest;Hablas espa&ntilde;ol?";
	print "<h1>$name</h1>";
?>
	...
	<div class="row-fluid">
		<ul class="nav nav-pills">
			...
			<li class="active"><a href="../es">Espa&ntilde;ol</a></li>
